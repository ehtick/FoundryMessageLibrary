...
{
	public class SPEC_Temperature : SPEC_SensorBase
	{
		public Temperature temperature { get; set; }


		public static SPEC_Temperature RandomSpec()
		{
			var gen = new MockDataGenerator();
			return new SPEC_Temperature()
			{
	...
	[System.Serializable]
	public class UDTO_Temperature : UDTO_SensorBase
	{
